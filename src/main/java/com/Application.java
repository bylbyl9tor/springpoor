...
public class Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            WithoutAutowired withoutAutowired = (WithoutAutowired) poorContext.getBean("3");//sin lazy true
            WithoutAutowired withoutAutowired1 = (WithoutAutowired) poorContext.getBean("3");//sin lazy true
            System.out.println("singletone lazy==singletone1 lazy\n" + (withoutAutowired == withoutAutowired1));
